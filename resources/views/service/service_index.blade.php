...
@section('content')
    ...
    <div class="row gutters">
        ...
        <div class="col-sm-8 col-9 text-right mb-2 px-3">
            <a href="{{ url('servico/novo', []) }}" class="btn btn-primary btn-rounded" style="font-weight: bold"><i class="icon-plus" style="font-size: 15px"></i>  Novo</a>
        </div>
    </div>
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="table-container">
                <div class="t-header">Lista de Servicos</div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="td-actions" style="justify-content: flex-start">
                                                ...
                                                <a href="#" class="icon" style="color: #000" data-toggle="tooltip" data-placement="top" title="" data-original-title="Editar">
