...
@section('content')
    ...
    <div class="row gutters">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <form action="{{ url('settings/role/update/'.$role->id, []) }}" method="post">
                {{-- @method('PACTH') --}}
                @csrf
                <div class="card">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        @foreach ($role->permissions as $permission_role)
                                            @if ($permission->id === $permission_role->id)
                                                checked
                                            @endif
                                        @endforeach
                                        name="permission_id[]"  class="custom-control-input" id="permission{{ $permission->id }}">
